...
// 참조). Export됨(계획3 최종리뷰 F1) — Canonicalize뿐 아니라 ingest.canonicalPath·
// main의 canonicalizeStoreRoot/canonicalizeAllowPaths도 이 함수 하나로 junction을 해석해야
// 경계 판정이 소비처마다 어긋나지 않는다(진실의 원천 단일화).
